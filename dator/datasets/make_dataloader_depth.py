...
from .bases import RGBD_Dataset
...
def train_collate_fn(batch):
    ...
    """
    imgs, depths, pids, camids, viewids, _ = zip(*batch)
...
def make_dataloader_depth(cfg):
    ...
    train_set = RGBD_Dataset(dataset.train, val_transforms) 
    ...
    val_set = RGBD_Dataset(dataset.query + dataset.gallery, val_transforms) 

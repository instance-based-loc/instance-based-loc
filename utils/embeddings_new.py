...
def get_all_vit_embeddings(**kwargs) -> torch.Tensor:
    ...
    # vit_embeddings = []
    # for image in images:
    #     vit_embedding = get_vit_embeddings(image, device)
    #     vit_embeddings.append(vit_embedding)
    # return torch.stack(vit_embeddings)
...
dator_model = load_model('/scratch/instance-loc/tum_best.pth')
dator_model.eval()

from dataloader.hm3d_dataloader import HM3Dataloader
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/scratch/vineeth.bhat/instance-loc/hm3d_trajectories/instance_nav_trajectories/episode_0"
    )
    parser.add_argument(
        "-e",
        "--eval-img-inds",
